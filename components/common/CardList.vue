<template>
  <div class="m-auto mx-auto max-w-256 px-4 pt-6">
    <div v-if="articleTopList.length" class="mb-10">
      <div class="flex mb-6">
        <div
          :class="[
      ...
      >
        ...
        <div
          id="scroll-animation"
          v-for="(data, index) in articleTopPageList"
          :key="data.article_id"
        >
          <div
          ...
          >
            ...
            >
              <div class="h-full relative">
                ...
                <!-- 时间部分 -->
                <div
                  class="flex justify-end items-center space-x-1 text-[var(--color2)] absolute bottom-0 right-0"
                >
      ...
      <div class="flex justify-center mt-6">
        <div
          v-if="articleTopPageList.length < articleTopList.length"
          :class="[
    ...
    <div v-if="pagination.total" class="mb-10">
      <div class="flex mb-6">
        <div
          :class="[
            'mr-2 px-4 py-1 rounded-2xl cursor-pointer bg-(--button-bg)  shadow-[0px_5px_15px_-3px_var(--button-bg)] transition-all active:scale-95',
